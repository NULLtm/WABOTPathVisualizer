...
object TrajectoryGen {
    ...
    fun createTrajectory(): ArrayList<Trajectory> {
        ...
        builder1
            ...
            .strafeTo(Vector2d(-44.0, -30.0)).splineTo(Pose2d(0.0, -36.0, 0.0), SplineInterpolator(0.0, 0.0))
            .splineTo(Pose2d(40.0, -30.0, 0.0), SplineInterpolator(0.0, 0.0))
            .setReversed(true)
            .splineTo(Pose2d(0.0, -36.0, 0.0), SplineInterpolator(0.0, 0.0))
            .splineTo(Pose2d(-64.0, -30.0, 0.0), SplineInterpolator(0.0, 0.0))
            .setReversed(false)
            .splineTo(Pose2d(0.0, -36.0, 0.0), SplineInterpolator(0.0, 0.0))
            ...
            .splineTo(Pose2d(40.0, -60.0, 0.0), SplineInterpolator((-90.0).toRadians, (-90.0).toRadians))
